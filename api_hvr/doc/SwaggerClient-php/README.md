...
------------ | ------------- | ------------- | -------------
*AgendaApi* | [**get**](docs/Api/AgendaApi.md#get) | **PUT** /agenda/cadastro.php | Retorna se o cpf ja está cadastrado no tasy
*AgendaApi* | [**getInventory**](docs/Api/AgendaApi.md#getinventory) | **PUT** /agenda/cadastro_pf.php | Retorna se o cpf ja está cadastrado no tasy
